...
routes.get("/dept_count", protect, getDeptCount);
routes.get("/user_comp_count", protect, getUserCompCount);
routes.get("/assignee_comp_count", protect, getAssigneeCompCount);
